...
export default function LoginPage() {
    ...
    return (
        <main className="h-screen bg-gray-50 overflow-hidden flex items-center justify-center">
            <div className="w-full max-w-md px-4 sm:px-6">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or{' '}
                        <Link href="/register" className="font-medium text-[var(--brand-royal-red)] hover:text-red-700">
