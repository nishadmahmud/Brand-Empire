 ...
 */
export async function filterProductsByAttributes(attributeValueIds = [], page = 1, brandId = null) {
    const cacheKey = `filter_products_${attributeValueIds.sort().join('_')}_page_${page}_brand_${brandId || 'all'}`;
    return getCachedOrFetch(cacheKey, async () => {
